...
public class WebInit implements WebApplicationInitializer
{
	...
	public void onStartup(ServletContext container) throws ServletException {
		...
		appContext.setDisplayName("PDMA application API");
...
//		FilterRegistration.Dynamic gzipFilter = container.addFilter("Gzip Compressor Filter",
...
//		gzipFilter.addMappingForUrlPatterns(null, false, "/*");
		...
		ServletRegistration.Dynamic servletDispatcher = container.addServlet("website",
				new DispatcherServlet(servletContext));
