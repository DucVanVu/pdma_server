...
@Service
public class _OpcSuccessfulTransOutWorker implements ReportingWorker<Boolean> {
    ...
    public Boolean call() throws Exception {
        ...
        List<CaseOrg> cos =
                coRepos.findCaseOrgsSuccessfulReferred(filter.getOrganization(), fromDate, toDate);
    ...
    public Sheet updateResultSheet(Sheet sheet) {
        ...
        ExcelUtils.writeInCell(sheet, 13, 9, indicator);
