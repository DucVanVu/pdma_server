...
public class OrganizationDto extends AuditableEntityDto {
	...
	private Set<StaffDto> staffMembers = new HashSet<>();
	...
	public OrganizationDto(Organization entity) {
		...
		if (entity.getStaffMembers() != null) {
			entity.getStaffMembers().parallelStream().forEach(s -> {
				this.staffMembers.add(new StaffDto(s, false));
			});
		}

		this.canNotBeCompleted = entity.getCanNotBeCompleted();
	}
	...
	public Organization toEntity() {
		...
		entity = (Organization) super.toEntity(entity);
	...
	public Set<StaffDto> getStaffMembers() {
	...
	public void setStaffMembers(Set<StaffDto> staffMembers) {
	...
	public Boolean getCanNotBeCompleted() {
		return canNotBeCompleted;
	}

	public void setCanNotBeCompleted(Boolean canNotBeCompleted) {
		this.canNotBeCompleted = canNotBeCompleted;
	}
}
