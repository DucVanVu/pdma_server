...
public class Case extends AuditableEntity {
	...
	@OneToMany(mappedBy = "theCase", cascade = CascadeType.ALL)
	@OrderBy("interviewDate DESC")
	private Set<ShiInterview> shiInterviews = new LinkedHashSet<>();

	@OneToMany(mappedBy = "theCase", cascade = CascadeType.ALL)
	@OrderBy("evaluationDate DESC")
	private Set<MMDispensing> mmdEvals = new LinkedHashSet<>();
	...
	@OneToOne(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "theCase")
	private MMT mmt;
	...
	public Set<ShiInterview> getShiInterviews() {
	...
	public void setShiInterviews(Set<ShiInterview> shiInterviews) {
		this.shiInterviews = shiInterviews;
	}

	public Set<MMDispensing> getMmdEvals() {
	...
	public void setMmdEvals(Set<MMDispensing> mmdEvals) {
