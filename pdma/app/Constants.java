...
public final class Constants {
	...
	/**
	 * Viral load result ranges
	 */
	public static final String VL_RESULT_UNDECTECTED = "Không phát hiện";
	
	public static final String VL_RESULT_UNDETECT_LT200 = "KPH - <200 bản sao/ml";
	
	public static final String VL_RESULT_200_LT1000 = "200 - <1000 bản sao/ml";
	
	public static final String VL_RESULT_GE1000 = ">=1000 bản sao/ml";

	public static final int NUMBER_OF_MONTH_FOR_EDIT = 4;
